          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <ul className="text-sm space-y-1">
                ...
                <li>• Must land in diagonal service box</li>
                <li>• Between service line (12') and net</li>
                <li>• Lets are replayed</li>
              </ul>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="text-sm space-y-2">
                  ...
                  <li>• In competitive play: switch every 6 points</li>
                </ul>
              </CardContent>
            </Card>
          </div>
  ...
  <div className="bg-gray-50 py-8 md:py-12">
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">How to Play SkyBall™</h1>
        <p className="text-xl text-gray-600">Get playing in 60 seconds with this quick guide</p>
      </div>
