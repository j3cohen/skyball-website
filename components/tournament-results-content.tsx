          ...
          {tournamentId === "skyball-100-may-20" && (
            <div className="mt-8 bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-700 mb-4">
                Points were allocated by a single elimination first round that caused 3 out of 6 players to move on to the
                final round. Then everyone played each other in the final round with the best record deciding the winner,
                using margin as a tie-breaker.
              </p>
              <div className="space-y-2">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-white font-bold mr-3">
                  ...
                  <div>
                    <div className="font-medium">Joe Swenson</div>
                    <div className="text-sm text-gray-500">50 points – 1-1 record, margin of +3</div>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center text-white font-bold mr-3">
                  ...
                  <div>
                    <div className="font-medium">Drew Afromsky</div>
                    <div className="text-sm text-gray-500">25 points – 1-1 record, margin of -1</div>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold mr-3">
                  ...
                  <div>
                    <div className="font-medium">Ben Poole</div>
                    <div className="text-sm text-gray-500">25 points – 1-1 record, margin of -2</div>
                  </div>
                </div>
              </div>
            </div>
