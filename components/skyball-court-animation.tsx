    ...
    <div ref={containerRef} className={`relative w-full ${isMobile ? "h-screen" : "aspect-[16/7]"} bg-gray-50 rounded-lg overflow-hidden shadow-lg`}>
      ...
      {quickAnimation && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div className="absolute bg-red-600" style={{ left: topServicePosition.x - 1.5, top: topServicePosition.y, width: 3, height: (serviceLineDistance - kitchenDepth) * Math.min(dimensions.width / (courtWidth + 10), dimensions.height / (courtLength + 10)), transformOrigin: "top" }} initial={{ scaleY: 0 }} animate={{ scaleY: 1 }} transition={{ duration: 0.8, delay: 1.9, ease: "easeOut" }} />
