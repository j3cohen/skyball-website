...
export default async function EventPage({ params }: { params: { id: string } }) {
  ...
  const isPastEvent = event.start_at ? new Date(event.start_at) < new Date() : event.isPast === true
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
              ...
              <div className="bg-sky-600 p-8 text-white">
                ...
                {!isPastEvent && event.description && <p className="mt-4 text-lg opacity-90">{event.description}</p>}
              </div>
                ...
                {!isPastEvent && (
                  <>
                    ...
                    <div className="mt-8 text-center">
                      ...
                      {event.paymentLink && (
                        <GuestRegistrationButton paymentLink={event.paymentLink} tournamentName={event.name} />
                      )}
                    </div>
                  </>
                )}
