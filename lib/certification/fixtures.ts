...
export const FIXTURE_COURSE: CourseOutline = {
  ...
  certificate: null,
  // Deliberately mixed shapes so ?demo=1 exercises every layout the admin
  // can author: intro+video, bare video, and a standalone module quiz.
  // The video-only sections carry passed:true because the server auto-passes
  // any section with no questions (lib/server/certCourse.ts).
  sections: [
    {
      id: "sec-1",
      ...
      introBody:
        "Over the next three videos you'll learn the official rules, core technique, and how to run engaging sessions. There's one quiz at the end covering all three — watch them in order, then take it.",
    ...
    },
    {
      ...
      position: 3,
      introEnabled: true,
      introTitle: "One quiz, all three videos",
      introBody:
        "This quiz covers everything from the three videos you just watched. You need 6 of 9 correct to earn your certificate — if you come up short you can rewatch and retake.",
      youtubeId: null,
      questions: [
        {
          id: "q-1a",
